...
public class Socialfragment extends Fragment {
    ...
    Adapter adapter;
    String country="in";
    private RecyclerView recyclerViewOfsocial;
    private String category="social";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.socialfragment,null);

        recyclerViewOfsocial=v.findViewById(R.id.recyclerviewofscience);
        modelClassArrayList=new ArrayList<>();
        recyclerViewOfsocial.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new Adapter(getContext(),modelClassArrayList);
        recyclerViewOfsocial.setAdapter(adapter);
